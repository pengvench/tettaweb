...
const PACKAGES = {
    ...
    ad: {
        ...
        features: [
            ...
            'камера, свет и запись звука',
            'базовый монтаж до 2 минут',
            'цвет, звук и простые плашки',
            '2 круга правок'
        ]
    },
    clip: {
        name: 'МУЗЫКАЛЬНЫЙ КЛИП',
        intro: 'Полный клип: от идеи до готового ролика.',
        shootHours: 6,
        shootMax: 12,
        editTier: 'basic',
        editMinutes: 4,
    ...
    // БАТЧ-17: «сниппет» и «вертикальный клип» — один пакет (смержены
    // по фидбеку), «лирик-видео» и «концертное видео» удалены.
    snippet: {
        name: 'ВЕРТИКАЛЬНЫЙ КЛИП',
        intro: 'Короткий вертикальный клип на фрагмент трека для соцсетей.',
        shootHours: 3,
        shootMax: 12,
        editTier: 'basic',
        editMinutes: 2,
...
//   data-price-packages="clip,snippet"      — какие пакеты и в каком порядке
...
const MANUAL_OPTIONS = [
    ...
    { name: 'ГРАФИКА И ИНФОГРАФИКА', price: 'от 5 000 ₽' },
